        ...
        <div className={"col-lg-3"}>
            <div className="card mb-3">
                ...
                <div className="card-body">
                    ...
                    {(user.entreprise == null) ? <Link className={"btn btn-primary"} to={`/ProfilDetailsPage/${user.id}`}>Voir le profil</Link>:
                    <Link className={"btn btn-primary"} to={`/ProfilEntreprisePage/${user.id}`}>Voir le profil</Link>}
